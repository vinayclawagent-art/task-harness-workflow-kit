...
Use [[Release Candidate Trial Packet]] on the next Mission Control release candidate so the generated workflow, traceability table, promotion card, and release handoff are filled in a single auditable pass.
