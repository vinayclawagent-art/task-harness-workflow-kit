...
Use the generated release-notes QA workflow on the next Mission Control release candidate, then compare the handoff quality against the markdown template.
