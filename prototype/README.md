...
Use [[Release Candidate Evidence Intake Card]] after the kickoff card and before [[Release Candidate Trial Packet]] on the next Mission Control release candidate so claim sources, verification checks, blockers, and handoff owner are pinned before validation evidence is written.
