...
next_focus: run the generated release-notes QA workflow during the next Mission Control release candidate and attach its traceability table
...
## Next focus
- Use [[../Prototypes/Task Harness Workflow Kit/Generated Workflow - Mission Control Release Notes QA]] on the next release candidate and attach the traceability table.
